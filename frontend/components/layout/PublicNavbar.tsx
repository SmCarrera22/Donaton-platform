        ...
        <nav className="sticky top-0 z-50 border-b bg-white">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-4">
                ...
                <div className="flex items-center gap-8">
                    <Link href="/about-us" className={active === "about" ? activeStyle : normalStyle}>
                        Acerca de Nosotros
                    </Link>

                    <div className="h-6 w-px bg-gray-300" />

                    <Link href="/login" className={active === "login" ? activeStyle : normalStyle}>
                        Iniciar sesión
                    </Link>

                    <Link href="/register" className={active === "register" ? activeStyle : normalStyle}>
                        Registrarse
                    </Link>
                </div>
            </div>
